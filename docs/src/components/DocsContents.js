...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      {label: 'Framework guides', to: '/integrations/frameworks'},
  ...
  },
  {
    ...
    links: [
      ...
      {label: 'Capabilities', to: '/api/capabilities'},
      {label: 'Exceptions', to: '/api/exceptions'},
      {label: 'Type system', to: '/api/type-system'},
      {label: 'Codecs', to: '/api/codecs'},
      {label: 'Cloud storage', to: '/api/cloud-storage'},
      {label: 'DataFrame bridges', to: '/api/dataframe-bridges'},
      {label: 'Async', to: '/api/async'},
      {label: 'Native batches', to: '/api/native-batches'},
      {label: 'Observability', to: '/api/observability'},
      {label: 'Plugins', to: '/api/plugins'},
    ],
  },
  {
    ...
    links: [
      ...
      {label: 'HTML', to: '/formats/html'},
      {label: 'TAR', to: '/formats/tar'},
      {label: 'Zarr', to: '/formats/zarr'},
    ],
  },
  {
    title: 'Development',
    to: '/development/contributing',
    description: 'Contributing, adding formats, release process, and type stubs.',
    links: [
      {label: 'Contributing', to: '/development/contributing'},
      {label: 'Adding formats', to: '/development/adding-formats'},
