...
- [publish-mcp-registry](./archive/2026-08-18-publish-mcp-registry/proposal.md) — PyPI `mcp-name` marker and OIDC publish of `server.json` on tagged releases
- Cookbook expanded to fifteen prompt-shaped scripts (PR #25); directory submission guide in `docs/docs/integrations/DIRECTORY_SUBMISSIONS.md`
