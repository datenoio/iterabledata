...
and any leading-byte signatures used for content-based detection. The set of descriptors SHALL be
the single source of truth for built-in format metadata.
