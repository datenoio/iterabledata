# cbor-format Specification

## Purpose
Support reading and writing Concise Binary Object Representation (CBOR, RFC 8949) data as records, including single items and arrays/sequences.
