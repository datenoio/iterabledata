# llm-catalog Specification

## Purpose
The LLM catalog capability exposes machine-readable format metadata and safe context utilities
for agents and external LLM integrations.
