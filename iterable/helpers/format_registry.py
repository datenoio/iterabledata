...
_LLM_METADATA: dict[str, dict[str, Any]] = {
    ...
    "delta": {
        ...
        "limitations": ("Path is table root directory",),
    },
    "iceberg": {
        ...
        "limitations": ("Requires catalog_name and table_name",),
    },
    "ducklake": {
        "description": "DuckLake tables: SQL catalog metadata with Parquet data files.",
        "doc_url": f"{_DOCS_BASE}/ducklake.md",
        "example_args": {"format": "ducklake", "table": "main.events", "data_path": "./data"},
        "limitations": ("Experimental", "Requires explicit format=ducklake; does not hijack .duckdb"),
    },
    "paimon": {
        "description": "Apache Paimon catalog tables via pypaimon (distinct from .row/.mosaic files).",
        "doc_url": f"{_DOCS_BASE}/paimon.md",
        "example_args": {"format": "paimon", "database": "default", "table": "orders"},
        "limitations": ("Experimental", "Distinct from paimon_row and paimon_mosaic file formats"),
    },
    "pb": {
...
_RAW_FORMAT_DESCRIPTORS: tuple[FormatDescriptor, ...] = (
    ...
    _fmt(
        id="delta",
        module="iterable.datatypes.delta",
        cls="DeltaIterable",
        flat=True,
        writable=True,
        maturity="partial",
    ...
    _fmt(id="psv", module="iterable.datatypes.psv", cls="PSVIterable", text=True, flat=True),
    ...
    _fmt(
        id="iceberg",
        module="iterable.datatypes.iceberg",
        cls="IcebergIterable",
        flat=True,
        writable=True,
        maturity="partial",
        ...
        native_bulk_read=True,
        native_bulk_write=True,
        selection=("catalog_name", "table_name"),
        source_constraints=("catalog",),
    ),
    ...
    _fmt(
        id="paimon_row",
        module="iterable.datatypes.paimon_row",
        cls="PaimonRowIterable",
        aliases=("row",),
        flat=True,
        extra="paimon-row",
        maturity="experimental",
        ...
        selection=("schema",),
        source_constraints=("filename",),
        example_args={"schema": [("id", "bigint"), ("name", "string")]},
        limitations=(
            "Experimental",
            "Schema is not embedded; reads require iterableargs schema",
            "Nested/VARIANT types not supported in the first cut",
        ),
    ),
    _fmt(
        id="paimon_mosaic",
        module="iterable.datatypes.paimon_mosaic",
        cls="PaimonMosaicIterable",
        aliases=("mosaic",),
        flat=True,
        extra="paimon-mosaic",
        maturity="experimental",
        ...
        selection=("columns",),
        source_constraints=("filename",),
        limitations=("Experimental", "Requires paimon-mosaic platform wheels"),
    ),
    _fmt(
        id="paimon",
        module="iterable.datatypes.paimon",
        cls="PaimonTableIterable",
        flat=True,
        extra="paimon-table",
        maturity="experimental",
        read_memory="bounded",
        ...
        native_bulk_read=True,
        native_bulk_write=True,
        selection=("database", "table", "columns"),
        source_constraints=("directory",),
        limitations=("Experimental", "Distinct from paimon_row / paimon_mosaic file formats"),
    ),
    _fmt(
        id="ducklake",
        module="iterable.datatypes.ducklake",
        cls="DuckLakeIterable",
        flat=True,
        extra="ducklake",
        maturity="experimental",
        read_memory="bounded",
        ...
        native_bulk_read=True,
        native_bulk_write=True,
        selection=("table", "data_path"),
        source_constraints=("filename",),
        limitations=("Experimental", "Requires explicit format=ducklake"),
    ),
    # OpenSpec: high-confidence open-data format gaps
    _fmt(
        id="fgdb",
        module="iterable.datatypes.filegdb",
        cls="FileGDBIterable",
        aliases=("gdb",),
        extra="geospatial",
        maturity="experimental",
        writable=False,
        read_memory="bounded",
        selection=("layer", "table"),
        source_constraints=("directory",),
    ),
    _fmt(
        id="mif",
        module="iterable.datatypes.mif",
        cls="MapInfoIterable",
        extra="geospatial",
        maturity="experimental",
        writable=False,
    ...
    _fmt(
        id="asc",
        module="iterable.datatypes.asciigrid",
        cls="ASCIIGridIterable",
        aliases=("ascii-grid", "asciigrid"),
        text=True,
        flat=True,
        maturity="experimental",
        read_memory="bounded",
    ...
    _fmt(
        id="bag",
        module="iterable.datatypes.bag",
        cls="BAGIterable",
        extra="hdf5",
        maturity="experimental",
        writable=False,
        read_memory="bounded",
        selection=("table", "dataset"),
        source_constraints=("filename",),
    ),
    _fmt(
        id="czml",
        module="iterable.datatypes.czml",
        cls="CZMLIterable",
        text=True,
        maturity="experimental",
        read_memory="whole_input",
    ),
    _fmt(id="xyz", module="iterable.datatypes.xyz", cls="XYZIterable", text=True, flat=True),
    _fmt(
        id="cif",
        module="iterable.datatypes.cif",
        cls="CIFIterable",
        text=True,
        flat=True,
        maturity="experimental",
    ...
    _fmt(id="pdb", module="iterable.datatypes.pdb", cls="PDBIterable", text=True, flat=True, selection=("model",)),
    _fmt(
        id="mat",
        module="iterable.datatypes.mat",
        cls="MATIterable",
        aliases=("matlab",),
        flat=True,
        extra="mat",
        maturity="experimental",
        writable=False,
        selection=("table", "variable"),
        source_constraints=("filename",),
    ),
    _fmt(
        id="segy",
        module="iterable.datatypes.segy",
        cls="SEGYIterable",
        extra="geophysical",
        maturity="experimental",
        writable=False,
    ...
    _fmt(
        id="grib2",
        module="iterable.datatypes.grib2",
        cls="GRIB2Iterable",
        aliases=("grib",),
        extra="geophysical",
        maturity="experimental",
    ...
    _fmt(
        id="mseed",
        module="iterable.datatypes.mseed",
        cls="MiniSEEDIterable",
        aliases=("miniseed",),
        extra="geophysical",
        maturity="experimental",
        writable=False,
    ...
    _fmt(
        id="mdb",
        module="iterable.datatypes.mdb",
        cls="AccessMDBIterable",
        aliases=("accdb",),
        flat=True,
        extra="access",
        maturity="experimental",
    ...
    _fmt(
        id="123",
        module="iterable.datatypes.lotus123",
        cls="Lotus123Iterable",
        aliases=("wk1", "wks"),
        flat=True,
        maturity="experimental",
        writable=False,
    ...
    _fmt(
        id="webdataset",
        module="iterable.datatypes.webdataset",
        cls="WebDatasetIterable",
        aliases=("wds",),
        maturity="experimental",
        writable=False,
        read_memory="bounded",
        selection=("decode_json", "partial_group"),
    ),
    _fmt(
        id="fst",
        module="iterable.datatypes.fst",
        cls="FSTIterable",
        flat=True,
        extra="fst",
        maturity="experimental",
    ...
    _fmt(
        id="iati",
        module="iterable.datatypes.iati",
        cls="IATIIterable",
        text=True,
        extra="xml",
        maturity="experimental",
...
_MODULE_INSTALL_EXTRAS: dict[str, str] = {
    ...
    "iterable.datatypes.paimon_row": "paimon-row",
    "iterable.datatypes.paimon_mosaic": "paimon-mosaic",
    "iterable.datatypes.paimon": "paimon-table",
    "iterable.datatypes.ducklake": "ducklake",
    ...
    "iterable.datatypes.filegdb": "geospatial",
    "iterable.datatypes.mif": "geospatial",
    "iterable.datatypes.las": "lidar",
    "iterable.datatypes.bag": "hdf5",
    "iterable.datatypes.mat": "mat",
    "iterable.datatypes.segy": "geophysical",
    "iterable.datatypes.grib2": "geophysical",
    "iterable.datatypes.mseed": "geophysical",
    "iterable.datatypes.mdb": "access",
    "iterable.datatypes.fst": "fst",
    "iterable.datatypes.hdt": "rdf",
    "iterable.datatypes.iati": "xml",
