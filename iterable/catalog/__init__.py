...
__all__ = ["describe_format", "export_catalog", "list_formats"]
...
def export_catalog(
    *,
    ...
    catalog = {fmt_id: describe_format(fmt_id, include_capabilities=include_capabilities) for fmt_id in list_formats()}
    if format == "json":
